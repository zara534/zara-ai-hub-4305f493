...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-500/20 via-purple-500/10 to-fuchsia-500/20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-foreground/90 font-semibold max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12 max-w-6xl mx-auto">
          <Card className="border-2 border-primary/30 bg-card/90 backdrop-blur hover:shadow-xl transition-all hover:-translate-y-1">
          ...
          <Card className="border-2 border-accent/30 bg-card/90 backdrop-blur hover:shadow-xl transition-all hover:-translate-y-1">
            <CardContent className="pt-6 pb-6 text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                DALL-E 3, Flux, Stable Diffusion & more AI models
              </p>
            </CardContent>
          </Card>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-2 border-primary/40 bg-card/90 backdrop-blur">
            <CardContent className="pt-6 pb-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="font-medium">mgbeahuruchizaram336@gmail.com</span>
                </a>
